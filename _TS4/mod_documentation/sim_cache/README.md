...
'Bella#Goth' should find 'Bella Goth'
'Be#Go' should find 'Bella Goth' and/or 'Ben God'
'b#g' should find 'Bella Goth' and other sims with the same initials.
'la#th' should find 'Bella Goth' and other sims with the last name characters as 'la' and 'th'
...
## Cheat Commands
* 'o19.sc.search firstname#lastname' - Search for a sim. If the first or last name has a space put in in quotes. Use '#' as a separator between the first and last name. 'Ann Ting#Lee' is not Ann#Ting Lee'!
* 'o19.sc.refresh' - Only newly created sims will be detected when loading into a zone. Use this command to detect name and gender changes without re-starting the games. 
* 'o19.sc.dump' - Dump all data to log.
